...
Evidence is found in support of Granovetter's Strength of Weak Ties that bridges and local bridges are disproportinately weak ties. However, some evidence suggests that these dynamics may change when the bridges occur between socially isolated individuals and individuals in giant component because of the greater stakes involved with that tie to the general community. 

The data collection process could interefere, as individuals were not necessarily
